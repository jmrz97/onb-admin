    ...
    <main class="home-page">
        ...
        <div class="row mt-4 mb-4 px-3">
            ...
            <div class="col-lg-8 d-flex justify-content-end">
                <button class="btn nuevo-airbnb d-flex justify-content-center">
                    <RouterLink to="/agregarsubcategoria" class="nav-link">
        ...
        <div>
            <table class="table border-top">
                ...
                <tbody>
                    <tr v-for="(subcategories, index) in subcategoriesList" :key="subcategories.id">
                        <td>{{ index +1 }}</td>
                        ...
                        <td class="td-actions text-center">
                            ...
                            <button type="button" rel="tooltip" class="btn btn-just-icon btn-sm" id="action-buttons" v-on:click="eliminar(subcategories.id)">
...
import axios from 'axios';
    export default {
        ...
        methods:{
            ...
            eliminar(id){
                axios.delete('/v1/subcategories/'+id)
                .then(response => {
